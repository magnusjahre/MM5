...
#ifndef __TSUNAMI_FAKE_HH__
#define __TSUNAMI_FAKE_HH__
...
/**
 * TsunamiFake is a device that returns -1 on all reads and 
 ...
 */
class TsunamiFake : public PioDevice
{
  private:
  ...
  public:
    /**
      ...
      */
    TsunamiFake(const std::string &name, Addr a, MemoryController *mmu, 
