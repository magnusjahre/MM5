...
class PerformanceEstimationMethod(Enum): vals = ['latency-mlp', 'ratio-mws', "latency-mlp-sreq", "no-mlp", "no-mlp-cache", "cpl", "cpl-cwp", "cpl-damp", "cpl-cwp-damp", "cpl-hybrid", "cpl-hybrid-damp", "cpl-cwp-ser", "bois", "ITCA", "private-latency-only", "shared-stall", "zero-stall", "const-1", "ASR", "lin-tree-10", "lin-tree-40", "lin-tree-80"]
