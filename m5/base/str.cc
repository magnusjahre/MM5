...
//     static const T signmax = (sign) ? maxnum & ( ( (T) 1 << (bits - 1) ) - 1) : maxnum; // original code
    static const T signmax = (sign) ? maxnum & (T) (((unsigned long long) 1 << (bits - 1) ) - 1) : maxnum; // g++ 4.3 fix
