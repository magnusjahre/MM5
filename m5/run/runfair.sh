...
wl=$3
np=$4
bms=`python -c "import fairmha.getInterference as g;g.getBenchmarks('$wl',True,$np)"`
args=$5
...
python -c "import fairmha.getInterference as g; g.getInterference('test_output.txt', $np, True)"
