...
def parse_isa_desc(isa_desc_file, output_dir, include_path):
    ...
    #namespace_output += namespace_code.decode_block // putting the code here breaks 4.3 compile
    non_namespace_output = namespace_code.decode_block
    update_if_needed(output_dir + '/decoder.cc', decode_file_template % vars())
