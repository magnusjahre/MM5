...
/**
 * @file
 * Declaration of the master interface for a BusBridge.
 */

#ifndef __BUS_BRIDGE_MASTER_HH__
#define __BUS_BRIDGE_MASTER_HH__
...
class BusBridgeMaster : public BusInterface<Bus>
{
  protected:
    BusBridge *bb;
  ...
  public:
     ...
     */
    BusBridgeMaster(const std::string &name, HierParams *hier, Bus *bus, 
		   BusBridge *bridge);

    /**
     * Free the internal storage.
     */
    virtual ~BusBridgeMaster() {}
