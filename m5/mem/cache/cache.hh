...
//     int interfaceID;
  ...
  public:
	  ...
	  public:
		  ...
		  memoryAddressParts(_memoryAddressParts), interferenceManager(intman), wbPolicy(_wbPolicy), shadowTagLeaderSets(_shadowLeaderSets)
		  {
		  }
	  };
