...
import __main__
__main__.m5_build_env =  {'STATS_BINNING': 1, 'ALPHA_TLASER': 0, 'SS_COMPATIBLE_FP': 1, 'NO_FAST_ALLOC': 0, 'USE_FENV': 1, 'FULL_SYSTEM': 0, 'USE_MYSQL': 1}
from m5 import *
AddToPath('/z/stever/bk/m5/build')
m5execfile('m5-test/memtest-iic-compressed/run.py', globals())
